...
// Sunucu (dugum) yapisini olusturduk..
struct Sunucu
{
    int id_no;
    float yuk;
...
struct Sunucu* bas = NULL;   //liste basini null a esitledik baslangicta bos olsun..
...
/* bu fonksiyonda baslangicta her dugumun yuk verisi 0 old. icin rastgele yerlestiriyor.. ama daha sonra en az yukten yuklemeye basliyor..
en az yukun kapasitesi dolana kadar ona yukluyoruz daha sonra o dolunda bi sonraki en aza yukluyor... */
